...
function initRegionComuna() {
  ...
  // Poblar regiones
  region_comuna.regiones.forEach((region, value) => {
  ...
  regionSelect.addEventListener("change", (seleccion) => {
    const regionSeleccionada = seleccion.target.value;
    ...
    if (regionSeleccionada !== "") {
      const comunas = region_comuna.regiones[regionSeleccionada].comunas;

      // Ordenamos las comunas alfabéticamente
